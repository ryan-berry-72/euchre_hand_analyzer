...
<div class="analyses">
    <div class="prompt" id="analysis-prompt">Projected number of trick wins for each possible trump suit:</div>
    <div class="analysis">
    ...
    <div class="information" id="algorithm-info">The projection is based on a customized machine learning algorithm. 
...
<script >
    ...
    function cardClick(card) {
        ...
        console.log(d3.select(card).datum());
        console.log("Cards selected: " + cardsSelected.length);
    }
    ...
    async function postData(url, data) {
        console.log("\nPosting data: " + JSON.stringify(data));
    ...
    function createEuchreCards() {
        const valuesOrder = [1,13,12,11,10,9];
